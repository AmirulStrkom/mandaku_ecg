...
class Dokumentasi_englishcamp extends CI_Controller
{
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Dokumentasi English Camp Berhasil Ditambah!</div>');
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Dokumentasi English Camp Berhasil DI Ubah!</div>');
            redirect('Dokumentasi_englishcamp');
        }
    }
}
