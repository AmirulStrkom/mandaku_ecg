        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    <h2 class="page-title text-white" style="font-family: Elephant;">Profil English Camp Pare AEC Man 2 Kuansing </h2>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-50 bg-img countnm-bx" style="background-image: url(assets/images/front-end-img/background/bg-3.jpg)" data-overlay="7" data-aos="fade-up">
    <div class="container-full" style="width: 80%; margin: 0 auto;">
        <div class="card-body text-center">
            <h2 class="card-title" style="font-family: Elephant; color: white;">VISI DAN MISI MAN 2 KUANTAN SINGINGI</h2>
        </div>
