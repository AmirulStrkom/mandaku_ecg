                        ...
                        <div class="box-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_buka" value="<?= set_value('tgl_buka') ?>" class="form-control" id="tgl_buka" placeholder="Nama Pengajar">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="periode_satu" value="<?= set_value('periode_satu') ?>" class="form-control" id="periode_satu">
                                    <?= form_error('periode_satu', '<small class="text-danger p1-3">', '</small>'); ?>
                                </div>

                                <div class="form-group">
                                    <label for="periode_dua">Periode Kedua</label>
                                    <input type="text" name="periode_dua" value="<?= set_value('periode_dua') ?>" class="form-control" id="periode_dua">
