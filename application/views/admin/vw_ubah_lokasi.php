    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h3 class="page-title">Halaman Edit Kontak dan Lokasi English Camp</h3>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="telepon">Telepon English Camp</label>
                                ...
                                <div class="form-group">
                                    <label for="email">Email English Camp</label>
