                            ...
                            if ($user['role'] == 'Admin') { ?>
                                ...
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?= base_url('Profil_englishcamp') ?>"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Profil English Camp</a></li>
                                        <li><a href="<?= base_url('Fasilitas_englishcamp') ?>"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Fasilitas English Camp</a></li>
